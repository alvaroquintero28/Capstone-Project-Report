...
\newpage
\textbf{Detailed Analysis of Stroke Incidence Dataset: Overview, Summary Statistics, and Correlation Insights}
\begin{figure}
    \centering
...
\newpage
\textbf{Distribution on Variables}
\begin{figure}
    \centering
...
\newpage
\textbf{Visual Analysis of Health Factors Associated with Stroke Incidence}
\begin{figure}
    \centering
...
\newpage
\textbf{Overall Correlation Trends}
\begin{figure}
    \centering
