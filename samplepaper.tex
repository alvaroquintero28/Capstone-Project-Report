...
\subsubsection{}
The distribution of daily stress levels, as illustrated by the histogram, shows a prevalent trend towards lower stress levels among the participants. The histogram reveals that a significant portion of the population reports daily stress levels on the lower end of the scale, accompanied by a smooth kernel density estimate (KDE) curve that accentuates this trend. In contrast, the boxplot representing sleep hours by gender reveals noteworthy differences between male and female participants. The median sleep hours for females are generally higher than those for males, suggesting that women in this sample prioritize or are able to achieve more sleep than men. 
\begin{figure}
    \centering
